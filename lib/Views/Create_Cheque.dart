...
class _CreateChequeState extends State<CreateCheque> {
  ...
  Widget build(BuildContext context) {
    return GetX<CreateChequeController>(
      builder: (_) {
        if(_.payees.length < 1 || _.myAccounts.length <1 || _.signa.length<1)
          {
            return Scaffold(
              appBar: AppBar(
                title: Text("Error"),
              ...
              body: Container(
                ...
                child: Center(
                  child: Text(
                    "Please add atleast 1 payee, 1 signature and 1 bank account to create a cheque",textAlign: TextAlign.center,
